"""This file contains metadata describing the results from QuickConformerSearch
...
the values are a dictionary describing the result. For example:
    ...
    metadata["results"] = {
        "total_energy": {
            ...
            "property": "total energy#QuickConformerSearch#{model}",
            "type": "float",
            "units": "E_h",
        },
    }
...
"""Properties that QuickConformerSearch produces."""
# metadata["results"] = {
#     "total_energy": {
#         "calculation": [
#             "energy",
