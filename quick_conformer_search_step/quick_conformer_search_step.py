...
class QuickConformerSearchStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Quick Conformer Search step. It must be
    ...
    my_description = {
        "description": "An interface for Quick Conformer Search",
        "group": "Simulations",
        "name": "Quick Conformer Search",
    }
    ...
    def description(self):
        ...
        """
        return QuickConformerSearchStep.my_description
