...
A SEAMM plugin for A SEAMM plug-in for a simple, quick conformer search
"""
import sys
...
setup(
    name='quick_conformer_search_step',
    author="Paul Saxe",
    ...
    url='https://github.com/molssi-seamm/quick_conformer_search_step',
    ...
    packages=find_packages(include=['quick_conformer_search_step']),
    ...
    entry_points={
        'org.molssi.seamm': [
            'Quick Conformer Search = quick_conformer_search_step:QuickConformerSearchStep',
        ],
        'org.molssi.seamm.tk': [
            'Quick Conformer Search = quick_conformer_search_step:QuickConformerSearchStep',
        ],
