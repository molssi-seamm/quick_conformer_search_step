...
do
	...
	sphinx-apidoc -o docs/developer quick_conformer_search_step
...
<html>
   <head>
      <title>Documentation for the Quick Conformer Search plug-in for SEAMM</title>
   </head>
   <body>
      <h1>Documentation for the Quick Conformer Search plug-in for SEAMM</h1>
      <h2>Branches</h2>
      <ul>
EOF
